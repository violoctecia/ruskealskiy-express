        ...
        <>
            <div id="popmechanic-form" className="video-widget" data-state="default">
                <div className="video-widget__container mutted">
                    ...
                    >
                        <source src="https://cdnv.boomstream.com/balancer/wMxPHfGz-U5NFGICa.mp4" type="video/mp4" />
                    </video>
                    <p className="video-text">Обращение <br/> команды поезда</p>
            ...
            <style jsx global>{`
                ...
                @media only screen and (max-width: 1023px), only screen and (max-width: 479px) {
                    .video-widget__container {
                        right: 24px;
                        bottom: 25px;
                        width: 140px;
